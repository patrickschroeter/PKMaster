...
export class ConferenceApi {
     ...
     * @param conferenceId ID of the Conference
     */
    public getApplicationsByConference (conferenceId: string, extraHttpRequestParams?: any ) : Observable<Array<models.ApplicationListDto>> {
     ...
     * @param conferenceId ID of the Conference
     */
    public getConferenceById (conferenceId: string, extraHttpRequestParams?: any ) : Observable<models.ConferenceListDto> {
        const path = this.basePath + '/conferences/{conferenceId}'
            .replace('{' + 'conferenceId' + '}', String(conferenceId));
