...
export class ConferenceApi {
     ...
     * @param conferenceId ID of the Conference
     */
    public getConferenceById (conferenceId: string, extraHttpRequestParams?: any ) : Observable<models.ConferenceDtoApplicationDto> {
        const path = this.basePath + '/conferences/{conferenceId}'
            .replace('{' + 'conferenceId' + '}', String(conferenceId));
     ...
     */
    public getConferences (filter?: string, sort?: string, extraHttpRequestParams?: any ) : Observable<Array<models.ConferenceDtoGuid>> {
        const path = this.basePath + '/conferences';
     ...
     */
    public updateConferenceById (conferenceId: string, conference?: models.ConferenceCreateDto, extraHttpRequestParams?: any ) : Observable<models.ConferenceDtoApplicationDto> {
        const path = this.basePath + '/conferences/{conferenceId}'
            .replace('{' + 'conferenceId' + '}', String(conferenceId));
