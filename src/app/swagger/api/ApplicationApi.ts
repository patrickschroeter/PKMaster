...
export class ApplicationApi {
     ...
     * @param applicationId ID of the Application
     */
    public getApplicationById (applicationId: string, extraHttpRequestParams?: any ) : Observable<models.ApplicationDto> {
        const path = this.basePath + '/applications/{applicationId}'
            .replace('{' + 'applicationId' + '}', String(applicationId));
     ...
     */
    public getApplications (filter?: string, sort?: string, extraHttpRequestParams?: any ) : Observable<Array<models.ApplicationDto>> {
        const path = this.basePath + '/applications';
     ...
     * @param applicationId
     */
    public getHistoryOfApplication (applicationId: string, extraHttpRequestParams?: any ) : Observable<Array<models.ApplicationDto>> {
