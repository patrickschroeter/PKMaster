...
export class UserApiMock {
    ...
    static USERS: AppUser[] = [
        ...
        { id: '1', email: 'admin@pk.de', password: 'password', firstname: 'Admin', lastname: 'PK-Admin', permissions: RoleApiMock.ROLE.Admin, roles: [RoleApiMock.ROLES_OBJECTS.Admin] },
        { id: '2', email: 'principal@pk.de', password: 'password', firstname: 'Principal', lastname: 'PK-Principal', permissions: RoleApiMock.ROLE.Principal, roles: [RoleApiMock.ROLES_OBJECTS.Principal] },
        { id: '3', email: 'member@pk.de', password: 'password', firstname: 'Member', lastname: 'PK-Member', permissions: RoleApiMock.ROLE.Member, roles: [RoleApiMock.ROLES_OBJECTS.Member] },
        { id: '4', email: 'docent@pk.de', password: 'password', firstname: 'Docent', lastname: 'PK-Docent', permissions: RoleApiMock.ROLE.Docent, roles: [RoleApiMock.ROLES_OBJECTS.Docent] },
        { id: '5', email: 'student@pk.de', password: 'password', firstname: 'Student', lastname: 'PK-Student', permissions: RoleApiMock.ROLE.Student, roles: [RoleApiMock.ROLES_OBJECTS.Student] },
        { id: '6', email: 'observer@pk.de', password: 'password', firstname: 'Observer', lastname: 'PK-Observer', permissions: RoleApiMock.ROLE.Observer, roles: [RoleApiMock.ROLES_OBJECTS.Observer] },
        { id: '7', email: 'secreteriat@pk.de', password: 'password', firstname: 'Secreteriat', lastname: 'PK-Secreteriat', permissions: RoleApiMock.ROLE.Secreteriat, roles: [RoleApiMock.ROLES_OBJECTS.Secreteriat] },
    ];
