...
export class FormApiMock {
    ...
    static FORM: Form = { 'title': 'Notennachberechnung', 'id': '1', 'formHasField': [{ 'fieldType': 'h3', 'name': 'header01', 'value': 'Hochschule für Angewandte Wissenschaften Augsburg', 'styles': [] }, { 'fieldType': 'input', 'name': 'firstname', 'required': false, 'label': 'Firstname', 'contentType': 'text', 'placeholder': '', 'value': '' }, { 'fieldType': 'input', 'name': 'lastname', 'required': true, 'label': 'Lastname', 'contentType': 'text', 'placeholder': '', 'value': '' }] };
