...
export class FormApiMock {
    ...
    static FORM: Form = { 'title': 'Notennachberechnung', 'id': '1', 'formHasField': [{ 'fieldType': 'h3', 'name': 'header01', 'value': 'Hochschule für Angewandte Wissenschaften Augsburg', 'styles': [] }, { 'fieldType': 'input', 'name': 'firstname', 'required': false, 'label': 'Firstname', 'contentType': 'text', 'placeholder': '', 'value': '' }, { 'fieldType': 'input', 'name': 'lastname', 'required': true, 'label': 'Lastname', 'contentType': 'text', 'placeholder': '', 'value': '' }, { 'fieldType': 'select', 'name': 'docent', 'required': false, 'label': 'Dozent', 'placeholder': '', 'multipleSelect': false, 'optionTable': 'user', 'options': [{ 'value': 'b904cc6e-b3a6-42a9-8880-3096be1b6c61', 'label': 'Schroeter, Patrick' }, { 'value': 'ee632373-432e-40f0-9f33-8cc6b684e673', 'label': 'Reichinger, Stephan' }, { 'value': '1', 'label': 'PK-Admin, Admin' }, { 'value': '2', 'label': 'PK-Principal, Principal' }, { 'value': '3', 'label': 'PK-Member, Member' }, { 'value': '4', 'label': 'PK-Docent, Docent' }, { 'value': '5', 'label': 'PK-Student, Student' }, { 'value': '6', 'label': 'PK-Observer, Observer' }, { 'value': '7', 'label': 'PK-Secreteriat, Secreteriat' }], 'value': '' }] };
